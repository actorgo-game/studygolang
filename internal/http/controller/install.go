...
func (InstallController) genConfig(ctx echo.Context) error {
	...
	config.ConfigFile.SetSectionComments("mongodb", "")
	config.ConfigFile.SetValue("mongodb", "host", dbhost)
	config.ConfigFile.SetValue("mongodb", "port", dbport)
	config.ConfigFile.SetValue("mongodb", "user", uname)
	config.ConfigFile.SetValue("mongodb", "password", pwd)
	config.ConfigFile.SetValue("mongodb", "dbname", dbname)
